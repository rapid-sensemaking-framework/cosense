...
var app = isRenderer ? window.require("electron").remote.app : require("electron").app;
var path = isRenderer ? window.require("electron").remote.require("path") : require("path");
